...
import { Moon, CheckCircle2, Circle, BellRing, ChevronRight, LayoutGrid } from "lucide-react";
...
export default function DashboardPage() {
  ...
  return (
    <div style={{ padding: "0 16px", paddingTop: 16 }}>
      ...
      {/* Score Card */}
      <div className="glass" style={{ borderRadius: 24, padding: 20, marginBottom: 16, background: "linear-gradient(135deg,rgba(110,231,183,0.08),rgba(52,211,153,0.05))" }}>
      ...
      {sortedTodayTasks.length > 0 && (
        <section style={{ marginBottom: 24 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
            ...
            <a href="/life/planner" style={{ fontSize: 13, color: "var(--accent)", fontWeight: 600, textDecoration: "none" }}>All →</a>
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
